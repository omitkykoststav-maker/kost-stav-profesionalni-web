...
<head>
  ...
  <meta name="description" content="Praktické články KOST STAV PRAHA s.r.o. o omítkách, zateplení fasád a fasádních pracích v Praze a Středočeském kraji.">
